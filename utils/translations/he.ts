export const he = {
    ...
    current_institution_score: "ניקוד מוסדי נוכחי:",
    ...
    add_stage_to_list: "הוסף שלב لرשימה",
    stage_name_placeholder: "למשל: שלב 1: היסודות",
    ...
    ai_prompt_title: "פרומפט לפרשן (Custom Prompt)",
    ...
    ai_instruction_commentator: "אתה מנטור חינוכי המקדם 'קנאת סופרים' – תחרות בונה ומצמיחה. תפקידך להפוך את לוח התוצאות למקור של השראה והנעה לפעולה. התמקד בחגיגת מאמץ, התקדמות אישית וקבוצתית, ותרומה לכלל. הצג את הצלחת האחר כמנוע לצמיחה של כולם. השתמש בשפה מעצימה, חיובית ושנונה.",
