...
campaign_not_found: "התחרות לא נמצאה או שהקישור אינו תקין.",
    ...
    points_short: "נקו'",
    to_stage: "לשלב",
    points_mgmt_desc: "בחר תלמידים והזן ניקוד מהיר",
    select_group_placeholder: "בחר קבוצה...",
    select_group_to_start: "נא לבחור קבוצה כדי להתחיל",
    ...
    enter_emoji_manual: "הכנס אמוג'י בעצמך:",
    ...
    goals_mgmt_desc: "קביעת הניקוד הדרוש לחשיפת שלבים והגדרת יעדים לקבוצות",
    ...
    ai_fallback_5: "שימו לב לזינוק המרשים! הדרך פתוחה לכולם!",
