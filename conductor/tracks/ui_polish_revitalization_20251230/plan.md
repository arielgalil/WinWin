...
- [ ] Task: Update `LanguageContext` or Root Layout to apply `dir="ltr/rtl"` based on the active language.
- [ ] Task: Audit and update `AdminLayout` and major components to use Tailwind logical properties (`ps-`, `pe-`, `ms-`, `me-`).
