...
export const KioskStartOverlay: React.FC<KioskStartOverlayProps> = ({
    onStart,
    isVisible,
    autoStartSeconds = 15,
}) => {
    const { t } = useLanguage();
    const [countdown, setCountdown] = React.useState(autoStartSeconds);

    React.useEffect(() => {
        setCountdown(autoStartSeconds);
    }, [autoStartSeconds]);
                ...
                >
                    ...
                    >
                        ...
                        <button
                            ...
                            aria-label={t("kiosk_start_button" as any) ||
                                "Start Presentation"}
