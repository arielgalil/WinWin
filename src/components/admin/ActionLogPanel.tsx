...
export const ActionLogPanel: React.FC<ActionLogPanelProps> = ({
    ...
    return (
        <div className="space-y-[var(--admin-section-gap)] flex flex-col h-full relative w-full" dir={isRTL ? 'rtl' : 'ltr'}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 flex-1 min-h-0">
                <div className="lg:col-span-2 flex flex-col gap-6 min-h-0 order-2 md:order-1">
                    <AdminSectionCard
