...
export const ProtectedRoute: React.FC<ProtectedRouteProps> = ({
    ...
    const isActuallyLoading = (authLoading && !user) || (slug && isLoadingCampaign && !campaign) || (isLoadingRole && !campaignRole);
    ...
    // If we are still loading the role in the background, don't show "Access Denied" yet
    if (!isAuthorized && isLoadingRole) {
        return <PageSkeleton type={skeletonType} message={t('identifying_permissions')} />;
    }
