        ...
        <div className="min-h-full flex flex-col bg-background text-foreground overflow-x-hidden" dir={dir}>
            ...
            <main className="relative z-10 w-full max-w-2xl mx-auto px-6 pt-8 md:px-8 md:pt-12 flex-1 pb-16 rtl:text-right ltr:text-left">
                ...
                <MotionDiv initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }} className="mb-10">
                    ...
                    <p className="text-muted-foreground text-sm mb-4">ארבעה כלים טכנולוגיים שהופכים את התיאוריה למציאות יומיומית - בלי להוסיף עומס על הצוות.</p>
                    <div className="space-y-3">
                        {[
                            {
                                emoji: '📺',
                            ...
                            },
                            {
                                ...
                                text: 'במקום פרס רק למנצח בודד, היעד המשותף מוצג כתמונה מוסתרת. כל נקודה שנצברת חושפת עוד חלק מהפאזל. לכל אחד יש חלק. הניצחון שייך לכולם יחד - לתלמיד, לקבוצה ולבית-הספר.',
                            },
                            {
                                emoji: '🎡',
                            ...
                            {
                                emoji: '📱',
                                title: 'הזנת נקודות - שלוש שניות מהמובייל',
                                text: 'כל מורה מזין נקודות ישירות מהטלפון - בוחר כיתה, מסמן תלמיד אחד או כמה בבת אחת, ולוחץ על ערך מוגדר מראש. הנקודות מופיעות על הלוח הגדול בזמן אמת. אפשר לתת לתלמידים אחראים גישה מוגבלת לניהול, לחפש לפי שם, להזין ניקוד חופשי ולצרף הערה לכל רשומה. בלי טפסים, בלי גיליונות אקסל.',
                            },
                        ].map(tool => (
