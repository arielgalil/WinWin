export const en = {
    ...
    viewers: "viewers",
    active_viewers: "Active viewers on board",
    ...
    more_points: "More",
    to_label: "to reveal the next prize",
    to_label_goal: "to finish the goal",
    to_label_stage: "to complete the stage",
    to_label_together: "and another stage done",
    ...
    import_excel_tooltip: "Include columns in the first row: 'Student Name', 'Grade', and 'Class Number' (optional)",
    ...
    // Lucky Wheel
    tab_lucky_wheel: "Lucky Wheel",
    lucky_wheel_mgmt_desc: "Lucky Wheel Template Management & Remote Control",
    new_wheel_template: "New Wheel Template",
    edit_wheel_template: "Edit Wheel Template",
    wheel_templates_title: "Wheel Templates",
    winner_history_title: "Winner History",
    filter_by_classes_label: "Filter by Classes",
    min_score_filter_label: "Min Score",
    max_score_filter_label: "Max Score",
    exclude_past_winners_label: "Exclude Previous Winners",
    ...
    round_prefix: "Round",
    participants_count_label: "%{count} participants",
    template_name_label: "Template Name",
    no_templates_yet_label: "No templates yet",
    create_first_template_desc:
        "Create your first wheel template to get started",
    all_classes_default_hint: "All classes selected by default",
    template_updated_toast: "Template updated",
    template_created_toast: "Template created with %{count} participants",
    no_participants_match_error: "No participants match the selected criteria",
    no_participants_match_warning: "No students match the current filters. Saving template with criteria only.",
    wheel_zero_participants_warning: "No students currently match filters. Activating empty wheel.",
    wheel_activated_toast: 'Wheel "%{name}" activated on all screens',
    wheel_deactivated_toast: "Wheel closed on all screens",
    ...
    phase_cruising: "Full speed...",
    phase_decelerating: "Slowing down...",
    phase_settling: "Almost there...",
    classes_plural: "Classes",
    activated_badge: "Activated",
    never_activated_badge: "Never Activated",
    last_activated_label: "Last Activated",
    live_status: "LIVE",
    confirm_delete_winner: "Confirm Winner Deletion",
    confirm_delete_winner_desc:
        "Are you sure you want to delete the following winner",
};
